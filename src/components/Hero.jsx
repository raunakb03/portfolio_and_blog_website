  ...
  return (
    <div className="w-screen h-screen relative z-50 hero-background">
      ...
      <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] max-w-[60rem] w-[80%]">
        ...
        <div className="text-[3.5rem] text-center text-[#111] tracking-[2px] font-[800]">
          HEY, I{`'`}M RAUNAK BHALOTIA
        </div>
        <div className="mt-[3rem] mx-auto font-[#333] text-[1.3rem] text-center w-[100%] leading-[1.6]">
      ...
      <a
        href="#about"
        className="mouse absolute bottom-10 left-1/2 w-[25px] h-[40px] border-[2px] border-solid border-[#333] rounded-[60px]"
      ></a>
    </div>
  );
};
